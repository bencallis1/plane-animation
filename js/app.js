...
//Lightning is certainly one of the trickiest parts when it comes to setting up a scene.
// The lights will set the mood of the whole scene and must be determined carefully.
// At this step of the project, we will just try to make the lightning good enough to make the objects visible.
